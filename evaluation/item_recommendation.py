...
class ItemRecommendationEvaluation(object):
    ...
    def folds_evaluation(self, folds_dir, n_folds, name_prediction, name_test, type_recommendation="normal",
